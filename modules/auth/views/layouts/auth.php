...
<head>
    ...
    <!-- Ionicons -->
    <link href="/resources/auth/css/ionicons.min.css" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
    <link href="/resources/auth/css/AdminLTE.css" rel="stylesheet" type="text/css" />
    <!-- jQuery 2.0.2 -->
    <script src="/resources/js/jquery.min.js"></script>
    <script src="/resources/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
    <script src="/resources/auth/js/AdminLTE/app.js"></script>
<!--    <script src="/resources/auth/js/AdminLTE/dashboard.js"></script>-->
    <!-- Bootstrap -->
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/auth/user/index"><i class="fa fa-angle-double-right"></i> 用户</a></li>
                        <li><a href="/auth/permission/index"><i class="fa fa-angle-double-right"></i> 权限</a></li>
                        <li><a href="/auth/role/index"><i class="fa fa-angle-double-right"></i> 角色</a></li>
